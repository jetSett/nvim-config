...
vim.keymap.set('n', '<leader>qd', ':bdelete<cr>', { desc = 'Delete buffer' })

vim.keymap.set('n', '<leader>G', ':Git<cr>', { desc = 'Open Gitsigns' })
  ...
  -- LSP Plugins
  {
    ...
    config = function()
      ...
      local servers = {
        ...
        -- pyright = {},
        --
        -- rust_analyzer not needed because we use rustacean
        -- rust_analyzer = {},
        --
